# generator — a Model Meets Reality starter
...
> Generate candidates AND state the class of thing this model claims it will not produce. That negative claim is the only falsifiable part.

And when a claim comes due:

> Did something appear that this model said it would not generate?
...
python -m suites.new_model my-model --kind generator \
